<div id="page-wrapper">
    <h2>base/contratante/New record</h2>
    <form action="http://local.factufacil/base/contratante/save" 
        ...
        <div class='form-group form-group-sm'> 
            ...
            <div class='col-sm-6'> 
                <div class='input-group col-sm-8'> 
                    <input type="text" id="f_contratante" name="f_contratante" class="form-control"  maxlength="45" required  />
                </div> 
            </div> 
        </div> 
        <div class='form-group form-group-sm'> 
        ...
        <div class='form-group form-group-sm'> 
            ...
            <div class='col-sm-6'> 
                <div class='input-group col-sm-8'> 
                    <input type="text" id="f_direccion" name="f_direccion" class="form-control"  maxlength="45"   />
                </div> 
            </div> 
        </div> 
        <div class='form-group form-group-sm'> 
        ...
        <div class='form-group form-group-sm'> 
            ...
            <div class='col-sm-6'> 
                <div class='input-group col-sm-8'> 
                    <input type="text" id="f_path_logo" name="f_path_logo" class="form-control"  maxlength="45"   />
                </div> 
            </div> 
        </div> 
        <div class='form-group form-group-sm'> 
            ...
            <div class='col-sm-6'> 
                <div class='input-group col-sm-8'> 
                    <input type="text" id="f_observacion" name="f_observacion" class="form-control"  maxlength="250"   />
                </div> 
            </div> 
        </div> 
        <div class='form-group form-group-sm'> 
