...
<div class='col-sm-6'> 
 <div class='input-group col-sm-8'> 
<input type="password" id="f_password" name="f_password" class="form-control"  maxlength="255" required  />
 </div> 
 </div> 
</div> 
<div class='form-group form-group-sm'> 
...
<div class='col-sm-6'> 
 <div class='input-group col-sm-8'> 
<input type="email" id="f_email" name="f_email" class="form-control"  maxlength="200"   />
 </div> 
 </div> 
</div> 
<div class='form-group form-group-sm'> 
