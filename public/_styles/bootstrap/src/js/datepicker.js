...
var datePickerController = (function datePickerController() {
        ...
        var localeDefaults = {
                fullMonths:["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre"],
                monthAbbrs:["Enero","Feb","Mar","Abr","May","Jun","Jul","Ago","Set","Oct","Nov","Dic"],
                fullDays:  ["Lunes","Martes","Miercoles","Jueves","Viernes","Sabado","Domingo"],
                dayAbbrs:  ["Lun","Mar","Mie","Jue","Vie","Sab","Dom"],
                titles:    ["Mes anterior","Mes siguiente","Año anterior","Año siguiente", "Hoy", "Show Calendar", "wk", "Week [[%0%]] of [[%1%]]", "Week", "Select a date", "Click \u0026 Drag to move", "Display \u201C[[%0%]]\u201D first", "Go to Today\u2019s date", "Disabled date :"],
                firstDayOfWeek:0,
                imported:  false
        };        
